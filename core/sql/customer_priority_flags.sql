...
-- WRITE functions: anon restored 2026-06-03 (see security_restore_priority_writes.sql).
-- These RPCs write to customer_priority_flags_raw only — internal workflow data,
-- no BC financials. Revoke anon again when Supabase Auth (Phase 3) lands.
