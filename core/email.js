...
function buildWeeklyDigestHtml_(s) {
  ...
  var html = '<!DOCTYPE html><html><head><meta charset="UTF-8">' + CSS + '</head><body>'
    ...
    + '<div style="color:#5b5b5b;font-size:11px;margin-top:2px;">vs ' + prevPeriod + '</div>'
    + '</div></div></div>'

    // Body
    + '<div class="sk-body">'
    + '<p style="margin:0 0 12px;color:#444;line-height:1.6;font-size:13px;">Hér er yfirlit yfir síðustu viku hjá Stórkaup. Allar tölur eru sjálfvirkt sóttar úr kerfinu.</p>'
